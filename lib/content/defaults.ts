...
export const defaults: AllContent = {
  ...
  s9_system: {
    ...
    step78: { label: "STEP 7–8", title: "冰導舒緩", arrow: "→ 兩道修護面膜", desc: "使用冰導舒緩精華，鎮靜、降低泛紅；接著兩道修護面膜深度保濕、修復肌膚屏障，使肌膚穩定、柔嫩有彈性" },
    step910: { label: "STEP 9–10", title: "PDT照光 → 完成", arrow: "→ 韓國醫美級護膚", desc: "專業光療促進修護，搭配最後一輪醫美級護膚精華加強肌膚吸收與修護。療程結束後，肌膚即刻展現健康光澤，平滑透亮、穩定有彈性" },
  },
