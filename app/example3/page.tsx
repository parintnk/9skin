        ...
        <div className="max-w-6xl mx-auto px-6 sm:px-10">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
            <div className="flex-1">
              ...
              {/* Founder story */}
              <div className="mt-8 rounded-sm p-6" style={{ backgroundColor: C.goldSoft, border: `1px solid ${C.goldBord}` }}>
                <div className="flex items-center justify-between mb-5">
                  <span className="px-4 py-1.5 rounded-full text-xs font-light tracking-widest"
                    style={{ backgroundColor: C.bgCard, color: C.gold, border: `1px solid ${C.goldBord}` }}>
                    創辦人的故事
                  </span>
